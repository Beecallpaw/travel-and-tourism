        ...
        <div class="row">
            <div class="col-md-10 col-sm-9">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt
                    eius magni provident, doloribus omnis minus temporibus perferendis nesciunt quam repellendus nulla nemo
                    ipsum odit corrupti</p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="aligncenter">
                    <h2 class="aligncenter">Our Featured Packages</h2>These are the list of featured packages available right now which you can book
                    at special discounts.</div>
                <br/>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="aligncenter">
                        <h2 class="aligncenter">Our Services</h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="about-image">
                    <img src="http://lorempixel.com/400/200/" alt="About Images">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>Sed ut perspiciaatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                    ...
                    explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur. <br><br>Sed ut perspiciaatis iste
                    natus error sit voluptatem probably haven't heard of them accusamus.</p>
            </div>
            <div class="col-md-4">
                <div class="block-heading-two">
                    ...
                    <div class="panel">
                        ...
                        <div id="collapseOne-alt3" class="panel-collapse collapse">
                            ...
                            <div class="panel-body">
                                Sed ut perspiciaatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque
